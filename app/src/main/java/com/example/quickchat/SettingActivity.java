...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtlikeview = findViewById(R.id.txtlikeview);
                                    ...
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                ...
                                                Toast.makeText(SettingActivity.this, "Your information Successfully Updated.", Toast.LENGTH_SHORT).show();
        ...
        Reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.hasChildren())
                    likedcount = (int) snapshot.child(auth.getUid()).getChildrenCount();
...
//
//                    }else{
                txtlikeview.append(String.valueOf(" ( " + likedcount + " Liked )"));
//                    }
//
//                }else{
//
